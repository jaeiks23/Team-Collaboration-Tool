...
<body class="sb-nav-fixed">
	<jsp:include page="../toolbar/toolbar_dark.jsp"/>
		<div id="layoutSidenav_content">
			<main>
				<h2  align="center" style="margin-right:50px;margin-top:10px">쪽지 보관함</h2>
   <form method="get">
      ...
      <button type="button" onclick="cancel();">보관해제</button>
      ...
      <table border="1" width="90%" style="margin-left:70px;">
         ...
         <c:choose>
         <c:when test="${empty keepList}">
         	<tr>
         		<td colspan="5" align="center">쪽지 보관함이 비어있습니다.</td>
         	</tr>
         </c:when>
         <c:otherwise>
       	<c:forEach items="${keepList}" var="list" varStatus="stat">
	<tr>
		<td align="center"><input type="checkbox" name="checkbox" id="${list.msg_mnum}," value="${list.msg_sendId}"></td>
		<td>${list.msg_sendId}</td>
		<td><a href="../pro/viewcon.do?mode=keep&mnum=${list.msg_mnum}">${list.msg_title}</a></td>
...
function sendMnum(){
	...
	location.href='../pro/delete.do?mode=keep&mnum='+checked;	
}	
...
function cancel(){
	...
	location.href='../pro/cancel.do?mnum='+checked;
