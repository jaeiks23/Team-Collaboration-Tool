...
public class ReceiveListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int totalCount=dao.receiveCountAll(map, id);
		...
		dto.setMsg_receiveId(id);
		
		List<messageDTO> receiveList = dao.receiveList(dto,map);
		dao.close();
		
		String pagingStr = PagingUtil.pagingCenter(totalCount, pageSize, end, pageNum, "../pro/receiveList.do");
...
//		System.out.println(pageNum);
		...
		req.getRequestDispatcher("../Message/ReceiveList.jsp").forward(req, resp);
