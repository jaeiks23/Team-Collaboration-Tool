...
public class SendListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int totalCount=dao.sendCountAll(map,id);
		...
		List<messageDTO> sendList =dao.sendMessageList(dto,map);
		dao.close();
		
		String pagingStr = PagingUtil.pagingCenter(totalCount, pageSize, end, pageNum, "../pro/SendList.do");
		...
		req.getRequestDispatcher("/Message/SendList.jsp").forward(req, resp);
